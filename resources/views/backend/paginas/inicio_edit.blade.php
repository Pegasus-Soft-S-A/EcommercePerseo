                    ...
                    <div class="form-group">
                        ...
                        <div class="row gutters-5">
                            ...
                            <div class="col-md-2">
                                <label>Fecha Inicio</label>
                                <div class="form-group">
                                    <input type="date" class="form-control"  name="inicio[]" value="{{ date(' Y-m-d')
                            }}" required>
                    </div>
                </div>
                <div class="col-md-2">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-10">
            <select name="top10_categories[]" class="form-control aiz-selectpicker" multiple data-max-options="10"
                data-live-search="true" @if(get_setting('top10_categories'))) data-selected="[{{implode(" ,"
                ,get_setting('top10_categories'))}}]" @endif>
