...
<div class="card">
    ...
    <div class="card-body">
        <div class="row">
            <input type="hidden" name="pedidosid" value="{{$pedido->pedidosid}}" id="pedidosid">
            <div class="form-group col-md-4 col-sm-6">
                <label for="fecha" class="col-form-label">Fecha</label>
                <input type="date" class="form-control form-control-sm" value="{{$pedido->emision}}" name="fecha"
                    id="fecha">
            </div>
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <select class="form-control form-control-sm aiz-selectpicker" name="clientes_sucursalesid">
                    ...
                    <option value="{{ $sucursal->clientes_sucursalesid }}" @if ($sucursal->clientes_sucursalesid ==
                        $pedido->clientes_sucursalesid) selected @endif>
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <input type="text" class="form-control form-control-sm" name="destinatario" id="destinatario"
                    placeholder="Ingrese Destinatario" autocomplete="off" value="{{$destinatario}}">
            </div>
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <select class="form-control form-control-sm aiz-selectpicker" name="centros_costosid">
                    ...
                    <option @if ($centro_costo->centros_costosid == $pedido->centros_costosid) selected @endif
                        value=" {{$centro_costo->centros_costosid}}">
                        {{$centro_costo->centro_costocodigo}}-{{$centro_costo->descripcion}}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <select class="form-control form-control-sm aiz-selectpicker" name="estado" id="estado">
                    <option value="1" @isset($pedido->estado)@if($pedido->estado==1 ) selected @endif
                        @endisset>Realizado
                    </option>
                    <option value="2" @isset($pedido->estado)@if($pedido->estado==2 ) selected @endif
                        @endisset>Confirmado
                    </option>
                    <option value="3" @isset($pedido->estado)@if($pedido->estado==3 ) selected @endif
                        @endisset>Facturado
                    </option>
                    <option value="4" @isset($pedido->estado)@if($pedido->estado==4 ) selected @endif @endisset>En
                        Entrega
                    </option>
                    <option value="5" @isset($pedido->estado)@if($pedido->estado==5 ) selected @endif
                        @endisset>Entregado
                    </option>
                    <option value="6" @isset($pedido->estado)@if($pedido->estado==6 ) selected @endif @endisset>No
                        Aplica
                    </option>
                </select>
            </div>
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <select class="form-control form-control-sm aiz-selectpicker" name="prioridad" id="prioridad">
                    <option value="0" @isset($pedido->prioridad)@if($pedido->prioridad==0 ) selected @endif
                        @endisset>No
                    </option>
                    <option value="1" @isset($pedido->prioridad)@if($pedido->prioridad==1 ) selected @endif
                        @endisset>Si
                </select>
            </div>
            ...
            <div class="form-group col-md-4 col-sm-6">
                ...
                <input type="text" class="form-control form-control-sm" name="urbano" id="urbano"
                    placeholder="Ingrese Codigo de Urbano" autocomplete="off" value="{{$urbano}}">
            </div>
...
<script>
    var detallesPedido = @json($detalles);
    $(document).ready(function() {
       ...
       // Función para calcular el total de una fila
        ...
        $('#btnGuardar').on('click', function (event) {
            ...
            $.ajax({
                url: '{{ route('pedidos.actualizar') }}',  // La URL a la que enviarás los datos.
                type: 'POST',
                data: {
