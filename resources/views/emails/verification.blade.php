                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <img src="data:image/jpg;base64,{{ get_setting('header_logo') }}"
                                            ...
                                            <tr class="">
                                                <td class="grid__col"
                                                    ...
                                                    <h2 style="color: #404040; font-weight: 300; margin: 0 0 12px 0; font-size: 24px; line-height: 30px; font-family: 'Benton Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica neue', Helvetica, Tahoma, Arial, sans-serif;"
                                                        class="">Su codigo para reestablecer la contraseña es el
                                                        siguiente:</h2>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td align="center" class="grid__col"
                                                    ...
                                                    <p
                                                        style=" font-weight: 300; margin: 0 0 12px 0; font-size: 24px; line-height: 30px; font-family: 'Benton Sans', -apple-system, BlinkMacSystemFont, Roboto, 'Helvetica neue', Helvetica, Tahoma, Arial, sans-serif;">
                                                        <strong>{{
                                                         $array['codigo'] }}</strong></p>
                                                </td>
                                            </tr>
                                            <tr>
