                                            ...
                                            <div class="row gutters-5">
                                                    ...
                                                    <span class="mr-2 ml-0">
                                                        @if ($imagenProducto)
                                                            <img src="data:image/jpg;base64,{{ base64_encode($imagenProducto->imagen) }}"
                                                                data-src="" class="img-fit lazyload size-60px rounded"
                                                                alt="">
                                                        @else
                                                ...
                                                <div class="col-lg col-4 order-3 order-lg-0 my-3 my-lg-0 text-center">
                                                    ...
                                                    <span class="fw-600 fs-16 text-primary ">$
                                                        {{ number_format(round($preciovisible * $cartItem['cantidad'], 2), 2) }}</span>
                                                </div>
                        ...
                        <form class="form-default" role="form" action="{{ route('login.cliente') }}"
                            ...
                            <div class="form-group">
                                <input type="text"
                                    ...
                                    value="{{ old('identificacion') }}" placeholder="Identificacion"
                        ...
                        <form class="form-default" role="form" action="{{ route('verificar.identificacion') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control h-auto form-control-lg"
                                    placeholder="Identificacion" name="identificacion" minlength="10" maxlength="13"
                                    pattern="[0-9]+" onkeypress="return validarNumero(event)" id="identificacion"
