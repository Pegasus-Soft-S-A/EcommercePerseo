        ...
        <div class="container">
            <div class="row cols-xs-space cols-sm-space cols-md-space">
                <div class="col-xxl-8 col-xl-10 mx-auto">
                    <form class="form-default" data-toggle="validator" action="{{ route('checkout.store_shipping_infostore') }}" role="form"
                        method="POST">
                        @csrf
                        @if (Auth::check())
                                    ...
                                    @foreach ($sucursales as $key => $address)
                                        <div class="col-md-6 mb-3">
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                <input type="radio" name="clientes_sucursalesid" value="{{ $address->clientes_sucursalesid }}"
                                                    ...
                                                    <span class="flex-grow-1 pl-3 text-left">
                                                        @if ($address->descripcion != '')
                                                            <div>
                                                                ...
                                                                <span class="fw-600 ml-2">{{ $address->descripcion }}</span>
                                                            </div>
                                                        @endif
                                                        <div>
