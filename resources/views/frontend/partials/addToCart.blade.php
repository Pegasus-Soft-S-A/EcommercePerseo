                            ...
                            @foreach ($imagenProducto as $imagenProduct)
                                <div class="carousel-box img-zoom rounded">
                                    <img class="img-fluid" loading="lazy"
                                        ...
                                        data-src="data:image/jpg;base64,{{ base64_encode($imagenProduct->imagen) }}"
                                        onerror="">
                                </div>
                            @endforeach
                        @else
            ...
            <div class="text-left">
                        ...
                        <div class="d-flex">
                            @if ((get_setting('controla_stock') == 0 && !Auth::check()) ||
                                ...
                                @if ($product->existenciastotales > 0)
                                    <div
                                        class="d-inline-block rounded px-2 border-success mt-1 mb-2 text-success border ml-2">
                                        <span>{{ get_setting('productos_disponibles') }}</span>
                                    </div>
                                @else
                                    <div class="d-inline-block rounded px-2 border-danger mt-1 mb-2 text-danger border ml-2">
                ...
                <form id="option-choice-form">
                    ...
                    <input type="hidden" id="variableinicio" name="variableinicio"
                        @if (get_setting('controla_stock') == 2) value="{{ session('almacenesid') }}" @else value="{{ $almacenes->almacenesid }}" @endif>
                            ...
                            <div class="product-quantity d-flex align-items-center">
                                <div class="row no-gutters align-items-center aiz-plus-minus mr-3"
                                    ...
                                    <input type="text" name="quantity" id="botonMas"
                                        ...
                                        @if (get_setting('controla_stock') == 0) max="{{ get_setting('cantidad_maxima') }}" @else max="" @endif
                                        autocomplete="off">
