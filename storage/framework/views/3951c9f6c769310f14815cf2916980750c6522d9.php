                ...
                <?php if($product != null): ?>
                    <li class="list-group-item">
                        <span class="d-flex align-items-center">
                            <a href="<?php echo e(route('product', $product->productosid)); ?>" class="text-reset d-flex align-items-center flex-grow-1">
...
<?php /**PATH C:\laragon\www\tienda\resources\views/frontend/partials/cart.blade.php ENDPATH**/ ?>