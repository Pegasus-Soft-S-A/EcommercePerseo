	...
	<div>
		<div style="background: #eceff4;padding: 1rem;">
			<table>
				<tr>
					<td>
						<img src="data:image/jpg;base64,<?php echo e(get_setting('header_logo')); ?>" height="30"
			...
			<table>
				<tr>
					<td style="font-size: 1rem;" class="strong"> <?php echo e($datosEmpresa->nombrecomercial); ?> </td>
					<td class="text-right"></td>
				</tr>
				<tr>
					<td class="gry-color small"><?php echo e($datosEmpresa->direccion); ?></td>
					<td class="text-right"></td>
				</tr>
				<tr>
					<td class="gry-color small"><?php echo e($datosEmpresa->email); ?></td>
					<td class="text-right small" style="text-align:right"><span class="gry-color small">Pedido:</span>
						<span class="strong"><?php echo e($order->pedidos_codigo); ?></span></td>
				</tr>
				<tr>
					<td class="gry-color small"><?php echo e($datosEmpresa->telefono1); ?></td>
					<td class="text-right small" style="text-align:right"><span class="gry-color small">Fecha:</span>
						<span class=" strong"><?php echo e($order->emision); ?></span></td>
				</tr>
			</table>
		...
		<div style="padding-top: 1rem; padding-left: 1rem; padding-right: 1rem;">
			<table>
				...
				<tr>
					<td class="strong"><?php echo e($cliente->razonsocial); ?></td>
				</tr>
				<tr>
					<td class="gry-color small">Dirección</td>
				</tr>
				<tr>
					<td class="gry-color small">Email: <?php echo e($cliente->email); ?></td>
				</tr>
				<tr>
			...
			<table class="padding text-left small border-bottom">
				...
				<tbody class="strong">
					...
					<tr>
						...
						?>
						<?php $__currentLoopData = $producto; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<td>
							<?php echo e($name->productocodigo); ?>

						</td>
						<td>
							<?php echo e($name->descripcion); ?>

						</td>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

						<td style="text-align:center"><?php echo e(number_format(round($pedidoDetail->cantidaddigitada,2),2)); ?>

						</td>
						<td class="currency" style="text-align:right">$
							<?php echo e(number_format(round($pedidoDetail->preciovisible,2),2)); ?></td>
								...
								<tbody>
									<tr>
										...
										<td style="text-align:right">
											<?php $__currentLoopData = $detalle; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $detalle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<?php
                                                        $precioCantidad =  $precioCantidad + $detalle->precio * $detalle->cantidaddigitada;
                                                ?>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											$ <?php echo e(number_format(round($precioCantidad,2),2)); ?>
									...
									<tr>
										...
										<td style="text-align:right">$
											<?php echo e(number_format(round($order->totaldescuento,2),2)); ?></td>
									</tr>
									<tr>
										<th class="gry-color text-left">Subtotal Neto</th>
										<td style="text-align:right">$
											<?php echo e(number_format(round($order->subtotalneto,2),2)); ?></td>
									</tr>
									<tr>
										<th class="gry-color text-left">IVA</th>
										<td style="text-align:right">$ <?php echo e(number_format(round($order->total_iva,2),2)); ?>
...
<?php /**PATH C:\laragon\www\tienda\resources\views/pedidos.blade.php ENDPATH**/ ?>