            ...
            <div class="shadow-sm bg-white p-3 p-lg-4 rounded text-left">
                ...
                <div class="mb-4">
                    <div class="row gutters-7 d-none d-lg-flex border-bottom mb-1 pb-3">
                        ...
                        <?php if(get_setting('productos_existencias') == 'todos' || get_setting('controla_stock') == 1 || (get_setting('controla_stock') == 2 && Auth::check())): ?>
                            ...
                            <li class="list-group-item px-0 px-lg-3">
                                <div class="row gutters-7 align-items-center">
                                    ...
                                    <div class="col-md-1 text-center">
                                        ...
                                        <span
                                            class="fw-600 fs-16">$<?php echo e(number_format(round($cartItem['precio_visible'], 2), 2)); ?></span>
                                    </div>
                                    ...
                                    <div class="col-md-2 text-center">
                                        <div class="row no-gutters align-items-center aiz-plus-minus mr-2 ml-0">
                                            ...
                                            <input type="number" name="quantity[<?php echo e($cartItem['ecommerce_carritosid']); ?>]"
                                                ...
                                                value="<?php echo e(round($cartItem['cantidad'], 2)); ?>" min="1"
                                    ...
                                    <div class="col-md-1 text-center">
                                        ...
                                        <span
                                            class="fw-600 fs-16 text-primary">$<?php echo e(number_format(round($cartItem['precio_visible'] * $cartItem['cantidad'], 2), 2)); ?></span>
                                    </div>

                                    <div class="col-md-1 text-center">
                                        <a href="javascript:void(0)" onclick="showObservacion(event, <?php echo e($cartItem['ecommerce_carritosid']); ?>)"
                                    ...
                                    <div
                                        <?php if(get_setting('productos_existencias') == 'todos' || get_setting('controla_stock') == 1 || (get_setting('controla_stock') == 2 && Auth::check())): ?> class="col-md-2 text-center" <?php else: ?>
                                    class="col-md-2 text-center invisible" <?php endif; ?>>
                                        <span class="opacity-60 fs-12 d-block d-lg-none ">Existencias</span>
                                        <?php if((get_setting('controla_stock') == 0 && !Auth::check()) || (get_setting('controla_stock') == 2 && !Auth::check())): ?>
                                        ...
                                        <?php else: ?>
                                            <div class="">
                                                <span class="fw-600 fs-16 text-primary"
                                                    id="cantidad"><?php echo e(round($cartItem['cantidad_final'], 2)); ?></span>
                                            </div>
                                        <?php endif; ?>
                                    </div>

                                    <div class="col-md-1 text-center">
                                        <a href="javascript:void(0)" onclick="removeFromCartView(event, <?php echo e($cartItem['ecommerce_carritosid']); ?>)"
                ...
                <?php if(get_setting('maneja_sucursales') == 'on'): ?>
                    <div class="px-3 py-2 border-top d-flex justify-content-between">
                        ...
                        <select class="form-control aiz-selectpicker" name="centros_costosid" data-live-search="true">
                            <?php $__currentLoopData = $centro_costos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $centro_costo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value=" <?php echo e($centro_costo->centros_costosid); ?>" <?php if($centro_costo->centros_costosid == session('centro_costo')): ?> selected <?php endif; ?>>
                                    <?php echo e($centro_costo->centro_costocodigo); ?>-<?php echo e($centro_costo->descripcion); ?>
                    ...
                    <div class="px-3 py-2 border-top d-flex justify-content-between">
                        ...
                        <select class="form-control aiz-selectpicker ml-5" name="sucursalesid" data-live-search="true">
                            <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value=" <?php echo e($sucursal->clientes_sucursalesid); ?>" <?php if($sucursal->clientes_sucursalesid == session('sucursal_carrito')): ?> selected <?php endif; ?>>
                    ...
                    <div class="px-3 py-2 border-top d-flex justify-content-between">
                        ...
                        <input type="text" class="form-control ml-4" name="destinatario" id="destinatario" autocomplete="off"
                            value="<?php echo e(session('destinatario')); ?>">
                    </div>
                <?php endif; ?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6 text-center text-md-right">
                        <?php if(Auth::check()): ?>
                            <a href="<?php echo e(route('verificarexistencias.shipping_info', Auth::user()->clientesid)); ?>" class="btn btn-primary fw-600">
                        ...
                        <form class="form-default" role="form" action="<?php echo e(route('login.cliente')); ?>" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text"
                                    ...
                                    value="<?php echo e(old('identificacion')); ?>" placeholder="Identificacion" name="identificacion" autocomplete="off">
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <?php if(get_setting('registra_clientes') == 'on'): ?>
                                    <a href="<?php echo e(route('user.registration')); ?>" class="btn btn-primary btn-block fw-600">Registrarse ahora</a>
                                <?php endif; ?>
                            </div>
                        </form>
                        <?php if(get_setting('registra_clientes') == 'on'): ?>
    ...
    <div class="modal fade" id="modalIdentificacion">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        <form class="form-default" role="form" action="<?php echo e(route('verificar.identificacion')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php /**PATH C:\laragon\www\tienda\resources\views/frontend/partials/cart_details.blade.php ENDPATH**/ ?>