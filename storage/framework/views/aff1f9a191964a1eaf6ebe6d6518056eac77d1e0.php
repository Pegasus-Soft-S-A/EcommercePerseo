                ...
                <form action="<?php echo e(route('business_settings.update_general')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <input type="text" class="form-control" name="APP_URL" value="<?php echo e(env('APP_URL')); ?>" placeholder="Ingrese App"
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="tipo_tienda">
                                    ...
                                    <option value="distribuidor" <?php if(get_setting('tipo_tienda') == 'distribuidor'): ?> selected <?php endif; ?>>
                                        Distribuidor
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="grupo_productos" id="grupo_productos">
                                    ...
                                    <option value="categorias" <?php if(get_setting('grupo_productos') == 'categorias'): ?> selected <?php endif; ?>>Categorias
                                    </option>
                                    <option value="subcategorias" <?php if(get_setting('grupo_productos') == 'subcategorias'): ?> selected <?php endif; ?>>
                                        Subcategorias</option>
                                    <option value="subgrupos" <?php if(get_setting('grupo_productos') == 'subgrupos'): ?> selected <?php endif; ?>>Subgrupos</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="facturador" id="facturador" data-live-search="true">
                                    <?php $__currentLoopData = $facturadores; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $facturador): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($facturador->facturadoresid); ?>" <?php if($facturador->facturadoresid == get_setting('facturador')): ?> selected <?php endif; ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="productos_existencias" id="productos_existencias"
                                    onchange="visualizar()">
                                    <option value="todos" <?php if($productos_existencias == 'todos'): ?> selected <?php endif; ?>>
                                        Todos
                                    </option>
                                    <option value="con_existencias" <?php if($productos_existencias == 'con_existencias'): ?> selected <?php endif; ?>>Con
                                        Existencias
                                    </option>
                                </select>
                            </div>
                        ...
                        <div class="form-group row" id="productos_disponibles">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="productos_disponibles" value="<?php echo e(get_setting('productos_disponibles')); ?>"
                                    placeholder="Productos Disponibles" maxlength="12">
                            </div>
                        </div>
                        <div class="form-group row" id="productos_no_disponibles">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="productos_no_disponibles"
                                    value="<?php echo e(get_setting('productos_no_disponibles')); ?>" placeholder="Productos no disponibles" maxlength="12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="tarifa_productos" id="tarifa_productos" data-live-search="true">
                                    <?php $__currentLoopData = $tarifas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarifa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tarifa->tarifasid); ?>" <?php if($tarifa->tarifasid == get_setting('tarifa_productos')): ?> selected <?php endif; ?>>
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">Correo(s) donde llegaran los pedidos y registros de clientes</label>
                            <div class="col-lg-8">
                                <input type="text" class="form-control aiz-tag-input" name="email_pedidos[]" id="email_pedidos"
                                    value="<?php echo e(get_setting('email_pedidos')); ?>" placeholder="Ingrese Correo">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="cupo_sucursal" <?php if(get_setting('cupo_sucursal') == 'on'): ?> checked <?php endif; ?>>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="maneja_sucursales" <?php if(get_setting('maneja_sucursales') == 'on'): ?> checked <?php endif; ?>>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="cliente_pedidos" id="cliente_pedidos"
                                        value="<?php echo e($clientes ? $clientes->clientesid : ''); ?>">

                                    <!-- Campo para la identificación del cliente -->
                                    <input type="text" class="form-control" name="identificacion_cliente_pedidos"
                                        id="identificacion_cliente_pedidos" value="<?php echo e($clientes ? $clientes->identificacion : ''); ?>"
                                    ...
                                    <input type="text" class="form-control" name="nombre_cliente_pedidos" id="nombre_cliente_pedidos"
                                        value="<?php echo e($clientes ? $clientes->razonsocial : ''); ?>" placeholder="Nombre Cliente" autocomplete="off"
                                        disabled>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="registra_clientes" <?php if(get_setting('registra_clientes') == 'on'): ?> checked <?php endif; ?>>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="grupo_clientes" id="grupo_clientes" data-live-search="true">
                                    <?php $__currentLoopData = $grupos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($grupo->clientes_gruposid); ?>" <?php if($grupo->clientes_gruposid == get_setting('grupo_clientes')): ?> selected <?php endif; ?>>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="tarifa_clientes" id="tarifa_clientes" data-live-search="true">
                                    <?php $__currentLoopData = $tarifas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tarifa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($tarifa->tarifasid); ?>" <?php if($tarifa->tarifasid == get_setting('tarifa_clientes')): ?> selected <?php endif; ?>>
                                            <?php echo e($tarifa->descripcion); ?>
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input type="checkbox" name="pago_pedido" <?php if(get_setting('pago_pedido') == 'on'): ?> checked <?php endif; ?>>
                                    <span></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input id="pagoplux" type="checkbox" name="pago_plux" <?php if(get_setting('pago_plux') == 'on'): ?> checked <?php endif; ?>
                                        onchange="visualizar()">
                                    <span></span>
                                </label>
                            </div>
                        ...
                        <div class="form-group row" id="email_pago_plux">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="email_pago_plux" value="<?php echo e(get_setting('email_pago_plux')); ?>"
                        ...
                        <div class="form-group row" id="pedido_pago_plux">
                            ...
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" name="pedido_pago_plux">
                                    ...
                                    <option value="factura" <?php if(get_setting('pedido_pago_plux') == 'factura'): ?> selected <?php endif; ?>>Factura
                                    </option>
                                </select>
                            </div>
                        </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $('#buscar').on('click', function() {
            ...
            $.post('<?php echo e(route('busqueda.cliente')); ?>', {
