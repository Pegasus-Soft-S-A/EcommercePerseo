                                        ...
                                        <li class="list-group-item px-0 px-lg-3">
                                            <div class="row gutters-7 align-items-center">
                                                ...
                                                <div class="col-md-1 text-center">
                                                    ...
                                                    <span class="fw-600 fs-16">$<?php echo e(number_format(round($cartItem['precio_visible'], 2), 2)); ?></span>
                                                </div>
                                                ...
                                                <div class="col-md-1 text-center">
                                                    <a href="javascript:void(0)" onclick="showObservacion(<?php echo e($cartItem['ecommerce_carritosid']); ?>)"
                                ...
                                <div class="px-3 py-2 border-top d-flex justify-content-between">
                                    ...
                                    <select class="form-control aiz-selectpicker ml-5" name="sucursalesid" data-live-search="true">
                                        <?php $__currentLoopData = $sucursales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sucursal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($sucursal->clientes_sucursalesid); ?>" <?php if($sucursal->clientes_sucursalesid == session('sucursalid')): ?> selected <?php endif; ?>>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('form[action="<?php echo e(route('cart.updateObservacion')); ?>"]').submit(function(e) {
                e.preventDefault(); // Evitar el envío normal del formulario

                var formData = $(this).serialize();
                $.ajax({
                    url: '<?php echo e(route('cart.updateObservacion')); ?>',
                    type: 'POST',
                    data: formData,
                    success: function(response) {
                        if (response.success) {
                            // Mostrar mensaje de éxito
                            //AIZ.plugins.notify('success', 'Observación guardada correctamente');
                            // Cerrar el modal
